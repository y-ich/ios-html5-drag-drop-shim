...
(function() {
  var DEBUG, DragDrop, ERROR, INFO, INLINE_TAGS, LOG_LEVEL, VERBOSE, average, div, doc, dragDiv, dragstart, evts, getEls, handler, log, needsPatch, noop, onEvt, once, parents,
  ...
  INLINE_TAGS = ['A', 'ABBR', 'ACRONYM', 'B', 'BDO', 'BIG', 'CITE', 'CODE', 'DFN', 'EM', 'I', 'KBD', 'LABEL', 'Q', 'SAMP', 'SMALL', 'SPAN', 'STRONG', 'SUB', 'SUP', 'TT', 'VAR'];
  ...
  DragDrop = (function() {
    ...
    function DragDrop(event, el) {
      ...
      this.el = el;
      if (INLINE_TAGS.some(function(e) {
        return e === el.tagName;
      }) && el.style.display === '') {
